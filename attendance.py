...
titl = tk.Label(window, bg="gray", relief=RIDGE, bd=10, font=("arial", 35))
titl.pack(fill=X)
l1 = tk.Label(window, image=logo1, bg="gray",)
l1.place(x=470, y=10)

titl = tk.Label(
    window, text="Smart College!!", bg="gray", fg="blue", font=("arial", 27),
)
...
def TakeImageUI():
    ...
    # image and title
    titl = tk.Label(
        ImageUI, text="Register Your Face", bg="gray", fg="blue", font=("arial", 30),
    )
